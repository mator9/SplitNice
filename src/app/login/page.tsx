    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-gradient-to-b from-white via-emerald-50/30 to-white dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-7">
          ...
          <h1 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Welcome to SplitNice</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Sign in to manage shared expenses</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800/80 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/60 p-6">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white dark:bg-slate-800/80 px-2 text-gray-400">or</span>
            </div>
          </div>
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 border border-gray-200 dark:border-slate-600 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors"
            >
